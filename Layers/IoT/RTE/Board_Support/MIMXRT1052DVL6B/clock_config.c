...
- {id: CCM.SAI1_CLK_PODF.scale, value: '2', locked: true}
- {id: CCM.SAI1_CLK_PRED.scale, value: '4', locked: true}
- {id: CCM.SAI2_CLK_PODF.scale, value: '2', locked: true}
...
- {id: CCM_ANALOG.PLL4.denom, value: '50', locked: true}
- {id: CCM_ANALOG.PLL4.div, value: '47', locked: true}
- {id: CCM_ANALOG.PLL4.num, value: '1', locked: true}
...
const clock_audio_pll_config_t audioPllConfig_BOARD_BootClockRUN =
    {
        .loopDivider = 47,                        /* PLL loop divider, Fout = Fin * ( loopDivider + numerator / denominator ) */
        ...
        .denominator = 50,                        /* 30 bit denominator of fractional loop divider, Fout = Fin * ( loopDivider + numerator / denominator ) */
        .src = 0,                                 /* Bypass clock source, 0 - OSC 24M, 1 - CLK1_P and CLK1_N */
    };
...
void BOARD_BootClockRUN(void)
{
    ...
    CCM_ANALOG->PLL_AUDIO_DENOM = CCM_ANALOG_PLL_AUDIO_DENOM_B(50);
    pllAudio = (CCM_ANALOG->PLL_AUDIO & (~(CCM_ANALOG_PLL_AUDIO_DIV_SELECT_MASK | CCM_ANALOG_PLL_AUDIO_POWERDOWN_MASK))) |
               CCM_ANALOG_PLL_AUDIO_ENABLE_MASK | CCM_ANALOG_PLL_AUDIO_DIV_SELECT(47);
